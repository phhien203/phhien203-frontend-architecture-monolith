...
function updateBundleComponentQuantity(
  product: Product,
  productId: string,
  quantity: number,
) {
      ...
      <SectionCard title="Product Details">
        ...
        >
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Wholesale and customer-specific pricing now lives next to the
                retail summary price.
              </p>
            </div>
            <Table>
              <TableHeader>
          ...
          {form.kind === "bundle" ? (
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Bundle inventory is derived from component stock, not from a
                  dedicated bundle location.
                </p>
              </div>
              <Table>
                <TableHeader>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Variant price and inventory now live alongside parent
                    summary fields.
                  </p>
                </div>
              </div>
          ...
          <div className="flex justify-end">
            <Button
              type="submit"
              disabled={mutation.isPending || !canEditCatalog}
            >
