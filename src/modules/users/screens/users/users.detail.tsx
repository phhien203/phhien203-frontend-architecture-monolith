...
export default function UserDetailPage() {
  ...
  const mutation = useMutation({
    mutationFn: (payload: Partial<AccountMember>) =>
      updateAccountUser(accountId, userId, payload),
    onSuccess: async () => {
    ...
    <div className="space-y-6">
      ...
      <SectionCard title="User Details" contentClassName="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              value={form.role}
              onChange={(event) =>
                setForm({ ...form, role: event.target.value as RoleKey })
              }
            >
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onChange={(event) =>
                setForm({
                  ...form,
                  status: event.target.value as AccountMember["status"],
                })
              }
            >
        ...
        <div className="flex justify-end">
          <Button
            disabled={!canManageUsers || mutation.isPending}
