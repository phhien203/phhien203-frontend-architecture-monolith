...
export default function SettingsPage() {
  ...
  return (
    <section className="space-y-6">
      <PageHeader
        title="Settings"
        description={`Operational settings for ${accountForm.name}.`}
      />
        ...
        >
          ...
          <div className="flex justify-end">
            <Button
              ...
              onClick={() =>
                void accountMutation.mutateAsync({
                  profile: accountForm.profile,
                })
              }
            >
              ...
              onChange={(event) =>
                setSettingsForm({
                  ...
                  shipping: {
                    ...
                    defaultCarrier: event.target.value,
                  },
                })
              }
            />
              ...
              <Input
                ...
                onChange={(event) =>
                  setSettingsForm({
                    ...
                    shipping: {
                      ...settingsForm.shipping,
                      standardRate: Number(event.target.value),
                    },
                  })
                }
              />
              ...
              <Input
                ...
                onChange={(event) =>
                  setSettingsForm({
                    ...
                    shipping: {
                      ...settingsForm.shipping,
                      expressRate: Number(event.target.value),
                    },
                  })
                }
              />
            ...
            <Button
              ...
              onClick={() =>
                void settingsMutation.mutateAsync({
                  shipping: settingsForm.shipping,
                })
              }
            >
        ...
        <SectionCard id="taxes" title="Taxes" contentClassName="space-y-4">
            ...
            <Input
              ...
              onChange={(event) =>
                setSettingsForm({
                  ...
                  taxes: {
                    ...settingsForm.taxes,
                    nexusRegion: event.target.value,
                  },
                })
              }
            />
          ...
          <ToggleSettingRow
            ...
            onCheckedChange={(checked) =>
              setSettingsForm({
                ...settingsForm,
                taxes: { ...settingsForm.taxes, pricesIncludeTax: checked },
              })
            }
          />
          <div className="flex justify-end">
            <Button
              ...
              onClick={() =>
                void settingsMutation.mutateAsync({ taxes: settingsForm.taxes })
              }
            >
