...
export default function OrdersPage() {
  ...
  return (
    <section className="space-y-6">
      <PageHeader
        title="Orders"
        description="Review order flow, fulfillment status, and customer purchases."
      />
            ...
            <TableBody>
              {filtered.map((order) => (
                <TableRow key={order.id}>
                  ...
                  <TableCell className="table-cell-muted">
                    {order.appliedPriceListName ?? "Retail default"}
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="table-cell-muted">
                    {order.returns.length} returns · {order.refunds.length}{" "}
                    refunds
                  </TableCell>
