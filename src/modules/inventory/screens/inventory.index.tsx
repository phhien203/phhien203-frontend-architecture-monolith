...
export default function InventoryPage() {
  ...
  return (
    <section className="space-y-6">
      <PageHeader
        title="Inventory"
        description="Track stock levels across warehouse locations and adjust counts."
      />
      <SectionCard>
        <Table>
          <TableHeader>
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Update stock quantity for {item.productName} in{" "}
                          {item.location}.
                        </DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(event) =>
                              setNextQuantity(Number(event.target.value))
                            }
                          />
                        </div>
