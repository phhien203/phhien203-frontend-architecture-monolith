            ...
            {data.map((discount) => (
              <TableRow key={discount.id}>
                ...
                <TableCell className="table-cell-muted">
                  {discount.rules.minimumSpend
                    ? `Min ${discount.rules.minimumSpend}`
                    : "No minimum"}
                  {discount.rules.eligibleSegments.length
                    ? ` · ${discount.rules.eligibleSegments.join(", ")}`
                    : ""}
                  {discount.rules.eligibleCategories.length
                    ? ` · ${discount.rules.eligibleCategories.join(", ")}`
                    : ""}
                </TableCell>
                <TableCell>
                  <StatusBadge
