      ...
      <section className="grid gap-6 xl:grid-cols-2">
        <Card className="xl:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              High-level growth trend pairing monthly revenue with order volume.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Weekly conversion rate trajectory for the last reporting window.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Category contribution to paid revenue.
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Where your current customer base is concentrated.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-6 lg:grid-cols-[1fr,0.9fr]">
            <ChartContainer
              config={{ value: { label: "Customers" } }}
              className="h-70"
            >
              <RadialBarChart
              ...
              >
                <PolarAngleAxis
                  ...
                  domain={[
                    0,
                    Math.max(...customerSegments.map((item) => item.value), 1),
                  ]}
                  tick={false}
                />
                <ChartTooltip
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Current order pipeline health across all tracked states.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
              config={{ value: { label: "Orders", color: "hsl(199 89% 48%)" } }}
              className="h-70"
            >
              <BarChart
                data={orderStatusMix}
